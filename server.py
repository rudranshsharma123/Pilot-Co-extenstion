...
# app = Flask(__name__)
db_params = dict(provider='cockroach', user='rudransh', host='free-tier.gcp-us-central1.cockroachlabs.cloud', port=26257, database='shiny-wolf-1947.defaultdb', password = "your password")
...
# This endpoint is used by the extentsion to get the images of doggos
